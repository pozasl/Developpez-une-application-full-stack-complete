...
public class SubscriptionServiceImplTest {
    ...
    @InjectMocks
    private SubscribtionServiceImpl subscriptionServiceImpl;
    ...
    void findSubsByTopicRef_shouldReturnSubsFlux() {
        ...
        subscriptionServiceImpl.findSubsByTopicRef("angular").as(StepVerifier::create)
    ...
    void findSubsByUserId_shouldReturnSubsFlux() {
        ...
        subscriptionServiceImpl.findSubsByUserId(1L).as(StepVerifier::create)
    ...
    void subscribeUserToTopic_shouldCreateSubAndReturnItsMono() {
        ...
        subscriptionServiceImpl.subscribeUserToTopic(2L, "java").as(StepVerifier::create)
    ...
    void unsubscribeUserToTopic_shouldDeleteSubAndReturnMonoVoid() {
        ...
        subscriptionServiceImpl.unsubscribeUserToTopic(1L, "angular").as(StepVerifier::create)
            .verifyComplete();
